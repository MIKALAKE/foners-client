    ...
    <div className="flex flex-col w-full h-full bg-primary">
      ...
      <div className="flex ml-5 mt-3 flex-col text-white text-3xl font-bold antialiased">
        ...
        <div className="flex flex-row justify-between overflow-x-auto">
          <DriverCard
            firstDriver="https://www.formula1.com/content/dam/fom-website/drivers/C/CHALEC01_Charles_Leclerc/chalec01.png.transform/2col/image.png"
            secondDriver="https://www.formula1.com/content/dam/fom-website/drivers/C/CHALEC01_Charles_Leclerc/chalec01.png.transform/2col/image.png"
            car="https://www.formula1.com/content/dam/fom-website/teams/2022/ferrari.png.transform/6col/image.png"
            firstName="Charles"
            lastName="Leclerc"
          />
          <DriverCard
